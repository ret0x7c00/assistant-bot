...
# auth token
AUTH_TOKEN = os.environ['DUOLINGO_AUTH_TOKEN']
TOTAL_CNT_MIN = os.environ['DUOLINGO_AUTH_TOKEN'] or 3
TOTAL_CNT_MAX = os.environ['DUOLINGO_AUTH_TOKEN'] or 15
SLEEP_TIME_MIN = os.environ['DUOLINGO_AUTH_TOKEN'] or 1
SLEEP_TIME_MAX = os.environ['DUOLINGO_AUTH_TOKEN'] or 6
...
def put_answer(respJson):
  ...
  payload2  = json.dumps(respJson, separators=(',', ':'), ensure_ascii=False).encode('utf8')
  headers = {
    'Authorization': AUTH_TOKEN,
    'Content-Type': 'application/json; charset=UTF-8',
    'Accept': 'application/json',
